...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    var authStore, CURRENT_USER, error_1;
    var _a;
    return __generator(this, function (_b) {
        switch (_b.label) {
            ...
            case 1:
                ...
                CURRENT_USER = authStore.getLoggedInUser();
                ...
                mustQuerySelector(document.body, '#profile-dept').textContent = ((_a = CURRENT_USER.companyDepartment) === null || _a === void 0 ? void 0 : _a.name) || 'No department specified';
                return [3 /*break*/, 3];
            case 2:
                error_1 = _b.sent();
