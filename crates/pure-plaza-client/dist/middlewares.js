...
export function checkIsLoggedInMiddleware(authStore) {
    return __awaiter(this, void 0, void 0, function () {
        var apiConnector, result, errorModal;
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, apiConnector.getLoggedInUser()];
                case 1:
                    result = _a.sent();
                    if (result.unauthorizedError !== null) {
                        ...
                        errorModal = mountModal('#error-modal-root', {
                            title: 'A critical error occured',
                            contentHtml: "".concat(result.unknownError),
                            primaryAction: {
                                label: 'Refresh page',
                                onClick: function () {
...
export function checkIsGuestMiddleware(authStore) {
    return __awaiter(this, void 0, void 0, function () {
        var apiConnector, result, errorModal;
        return __generator(this, function (_a) {
            switch (_a.label) {
