...
(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    function clearAllErrors() {
        Object.values(fields_1).forEach(function (f) { return f.clearError(); });
    }
    ...
    var navbar, fields_1, cancelBtn, submitBtn, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
            ...
            case 1:
                ...
                navbar = mountNavbar('#navbar-root', __assign({ brandHref: '/', brandName: 'Confilogi', brandAccent: 'IT Support' }, LOGGED_IN_NAVBAR_ARGS));
                fields_1 = {
                ...
                submitBtn = mountButton('#submit-btn', {
                    label: 'Submit',
                    variant: 'primary',
                    size: 'md',
                    type: 'button',
